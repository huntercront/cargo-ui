! function(t) { "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? module.exports = t() : window.Picker = t() }(function() { "use strict"; var k = { header: "calendar-header", button: "calendar-button", buttonDecrease: "calendar-button-decrease", buttonIncrease: "calendar-button-increase", headerMonth: "calendar-header-month", monthName: "calendar-month-name", dayName: "calendar-day-name", row: "calendar-row", table: "calendar-table", calendar: "calendar", cell: "calendar-cell", date: "calendar-date", week: "calendar-week", isOtherMonth: "calendar-is-other-month", isCurrentMonth: "calendar-is-current-month", isEdge: "calendar-is-edge", isStart: "calendar-is-start", isOutside: "calendar-is-outside", isBeforeStart: "calendar-is-before-start", isEnd: "calendar-is-end", isAfterEnd: "calendar-is-after-end", isOk: "calendar-is-ok" };
    ...
    function g(t, e) { for (var a, n, r, o = (a = t, n = (a = new Date(a)).getDay(), r = a.getDate() - n + (0 === n ? -6 : 1), new Date(a.setDate(r))), i = "", s = 0; s < 6; s++) { i += '<tr class="' + k.row + " " + k.week + '">'; for (var d = 0; d < 7; d++) i += "<td " + e(o, t) + ">" + o.getDate() + "</td>", o.addDays(1);
            i += "</tr>" } return i + "" }

    function T(t, e, a, n, r, o) { var i, s, d, u, c, l, h = document.createElement("div"),
            f = ""; return f += (i = t, s = e, d = a, c = r, l = "", u = (u = n) && (!s || !d.twoCalendars), c = c && (s || !d.twoCalendars), l += '<div class="' + k.header + '">', u && (l += '<div class="' + k.button + " " + k.buttonDecrease + '">' + d.icon + "</div>"), l += '<div class="' + k.headerMonth + '"><strong class="' + k.monthName + '">' + d.monthNames[i.getMonth()] + "</strong> " + i.getFullYear() + "</div>", c && (l += '<div class="' + k.button + " " + k.buttonIncrease + '">' + d.icon + "</div>"), l += "</div>"), f += '<table class="' + k.table + '">', f += '<tr class="' + k.row + '">' + a.dayNamesShort.map(function(t) { return '<th class="' + k.cell + " " + k.dayName + '">' + t + "</th>" }).join("") + "</tr>", f += g(t, o), f += "</table>", h.className = k.calendar, h.innerHTML = f, h }

    function t(r, i) { if (!r) throw new Error("noUiDatePicker requires a single element."); if (!N(i.min) || !N(i.max)) throw new Error("noUiDatePicker requires valid dates."); var s = S(i.min).null(),
            d = S(i.max).null(),
            n = S(s),
            u = !1,
            c = !1,
        ...
        function g(t, e) { var a, n = [k.cell, k.date],
                r = "true",
                o = !1; return t.getMonth() !== e.getMonth() ? (n.push(k.isOtherMonth), r = "false") : (n.push(k.isCurrentMonth), o = !0), t.getTime() === s.getTime() ? (n.push(k.isEdge), n.push(k.isStart)) : t < s ? (r = "false", n.push(k.isOutside), n.push(k.isBeforeStart)) : t.getTime() === d.getTime() ? (n.push(k.isEdge), n.push(k.isEnd)) : d < t ? (r = "false", n.push(k.isOutside), n.push(k.isAfterEnd)) : o && n.push(k.isOk), 'data-calc="' + L(a = t) + '" data-day="' + a.getDay() + '" data-date="' + a.getDate() + '" data-month="' + a.getMonth() + '" data-year="' + a.getFullYear() + '" data-valid="' + r + '" class="' + n.join(" ") + '"' }

        function p() { n.setDate(1); var t = S(n);
            h = s <= t, o = t <= f, m(), r.innerHTML = "", r.appendChild(T(t, 0, i, h, o, g)), i.twoCalendars && r.appendChild(T(t.addMonths(1), 1, i, h, o, g)); var e = r.querySelector("." + k.buttonDecrease),
        ...
        function v(a, n) { var t;
            t = r.querySelectorAll("." + k.date + "." + k.isCurrentMonth), (e = Array.prototype.slice.call(t)).forEach(function(t) { var e = Number(t.getAttribute("data-calc"));
        ...
        function E(t) { if (!N(t)) throw new Error("date not valid (" + t + ")"); var e, a;
        ...
        p(), r.addEventListener("click", t); var a = { prev: M, next: w, get: function() { var t = O(c),
                    e = O(l),
                    a = !1; return t && e && (a = Math.round((e - t) / 864e5)), { start: t || O(u), end: e, nights: a, days: !!a && a + 1 } }, set: E, select: function(t, e, a) { E(t = A(t)), D(b(t), !0), e && i.twoCalendars && D(b(A(e)), !0), a || y("Select") }, clear: C, destroy: function() { r.removeEventListener("click", t), r.innerHTML = "" } }; return a } return Date.prototype.null = function() { return this.setHours(0, 0, 0, 0), this }, Date.prototype.addDays = function(t) { return this.setDate(this.getDate() + t), this }, Date.prototype.addMonths = function(t) { return this.setMonth(this.getMonth() + t), this }, Date.prototype.Ymd = function() { return this.getFullYear() + "-" + e(this.getMonth() + 1) + "-" + e(this.getDate()) }, t.prototype.pad = e, t.prototype.copy = S, t.prototype.isValidDate = N,
        function() { var t = document.createElement("input");
            t.setAttribute("type", "date"); var e = "not-a-date"; return t.setAttribute("value", e), t.value !== e }() || document.documentElement.classList.add("js-no-type-date-support"), t });